...
// ==============================================================
#ifndef __canny_edge_detectbkb__HH__
#define __canny_edge_detectbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_detectbkb) {
    ...
    SC_CTOR(canny_edge_detectbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
