...
// ==============================================================
#ifndef __canny_edge_detectcud__HH__
#define __canny_edge_detectcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_detectcud) {
    ...
    SC_CTOR(canny_edge_detectcud):  simcore_mac_0_U ("simcore_mac_0_U") {
