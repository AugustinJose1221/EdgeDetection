...
// ==============================================================
#ifndef __canny_edge_detectdEe__HH__
#define __canny_edge_detectdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_detectdEe) {
    ...
    SC_CTOR(canny_edge_detectdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
