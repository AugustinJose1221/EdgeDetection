...
// ==============================================================
#ifndef __canny_edge_detectg8j__HH__
#define __canny_edge_detectg8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_detectg8j) {
    ...
    SC_CTOR(canny_edge_detectg8j):  ACMP_sitofp_U ("ACMP_sitofp_U") {
