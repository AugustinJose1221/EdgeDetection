...
#ifndef _canny_edge_detection_1_1_HH_
#define _canny_edge_detection_1_1_HH_
...
struct canny_edge_detection_1_1 : public sc_module {
    ...
    sc_in< sc_lv<8> > hist_hthr;
    sc_in< sc_lv<8> > hist_lthr;
    ...
    // Module declarations
    canny_edge_detection_1_1(sc_module_name name);
    SC_HAS_PROCESS(canny_edge_detection_1_1);
