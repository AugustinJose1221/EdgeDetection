...
// ==============================================================
#ifndef __canny_edge_detectkbM__HH__
#define __canny_edge_detectkbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(canny_edge_detectkbM) {
    ...
    SC_CTOR(canny_edge_detectkbM):  simcore_mac_2_U ("simcore_mac_2_U") {
