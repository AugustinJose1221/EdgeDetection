...
set ID 32
set hasByteEnable 0
set MemName Sobel_512u_512u_sfYi
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_fifo2 \
    op interface \
    ports { fifo2_dout { I 8 vector } fifo2_empty_n { I 1 bit } fifo2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo3_value_din { O 8 vector } fifo3_value_full_n { I 1 bit } fifo3_value_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { fifo3_grad_din { O 2 vector } fifo3_grad_full_n { I 1 bit } fifo3_grad_write { O 1 bit } } \
} "
}
