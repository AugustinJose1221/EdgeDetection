...
module canny_edge_detection_1_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (hist_lthr_out_full_n == 1'b0) | (hist_hthr_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (hist_lthr_out_full_n == 1'b0) | (hist_hthr_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (hist_lthr_out_full_n == 1'b0) | (hist_hthr_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign hist_hthr_out_din = hist_hthr;

assign hist_lthr_out_din = hist_lthr;

endmodule //canny_edge_detection_1_1
